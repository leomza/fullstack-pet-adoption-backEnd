        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, usersDAO.getTheUserById(userId)];
                case 1:
                    user = _a.sent();
...
function checkIsAdmin(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var token, decoded, cookie, id, user, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    if (!req.cookies.token) return [3 /*break*/, 2];
                    token = req.cookies.token;
                    decoded = jwt.decode(token, process.env.SECRET_KEY);
                    cookie = JSON.parse(decoded);
                    id = cookie.id;
                    return [4 /*yield*/, usersDAO.getTheUserById(id)];
                case 1:
                    user = _a.sent();
                    if (user.role === 'admin') { // user is admin
                        req.admin = true;
