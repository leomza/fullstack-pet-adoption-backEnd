...
var UsersDAO = /** @class */ (function () {
    ...
    UsersDAO.createUser = function (userToAdd) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, usersSchema.create(userToAdd)];
                    case 1:
                        queryResult = _a.sent();
    ...
    UsersDAO.findUser = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, usersSchema.findOne({ email: email })];
                    case 1:
                        queryResult = _a.sent();
                        return [2 /*return*/, queryResult];
                    case 2:
    ...
    UsersDAO.modifyUser = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, usersSchema.findByIdAndUpdate(id, data, { "new": true })];
                    case 1:
                        queryResult = _a.sent();
                        return [2 /*return*/, queryResult];
                    case 2:
    ...
    UsersDAO.getTheUserById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, usersSchema.findOne({ _id: id })];
                    case 1:
                        queryResult = _a.sent();
                        return [2 /*return*/, queryResult];
                    case 2:
    ...
    UsersDAO.getAllTheUsers = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, usersSchema.find()];
                    case 1:
                        queryResult = _a.sent();
                        return [2 /*return*/, queryResult];
                    case 2:
